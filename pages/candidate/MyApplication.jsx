...
{uploadedCV && (
  <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
    <p className="text-green-700 text-sm">
      ✅ CV uploaded: {uploadedCV.fileName}
    </p>

    <a
      href={`http://localhost:8002${uploadedCV.filePath}`}
      target="_blank"
      rel="noopener noreferrer"
      className="inline-flex justify-center px-4 py-2 rounded-lg text-sm font-semibold text-white bg-slate-900 hover:bg-slate-800 transition"
    >
      View My CV
    </a>
  </div>
